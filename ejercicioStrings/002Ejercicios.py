...
cadena = "Hola esta es mi\ncadena que tiene un salto de linea"
print(cadena)
...
print(f"Mi nombres es {name} {lastName}, y mi edad es {age}")
...
string = "aprendiendo python"
print(string.upper())

"""9. Cuenta cuántas veces aparece la letra “n” en la cadena 
“Programación en Python”."""

otherString = "Programacion en Python"
print(otherString.count("n"))

"""10. 
Verifica si la cadena “12345” es numérica usando el 
